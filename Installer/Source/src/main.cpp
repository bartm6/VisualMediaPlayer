...
private:
    ...
    void Layout() {
        ...
        if(playerPrevHwnd_){
            ...
            HRGN region=CreateRoundRectRgn(0,0,kMediaNavEdgeWidth+1,kMediaNavEdgeHeight+1,12,12); SetWindowRgn(playerPrevHwnd_,region,FALSE);
        }
        if(playerNextHwnd_){
            ...
            HRGN region=CreateRoundRectRgn(0,0,kMediaNavEdgeWidth+1,kMediaNavEdgeHeight+1,12,12); SetWindowRgn(playerNextHwnd_,region,FALSE);
        }
